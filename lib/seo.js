...
// NOTE: swap SITE_URL to the production domain (alphabellewellness.com) when it's live.

export const SITE_URL = "https://alphabelle-web-jet.vercel.app";
...
export const BUSINESS = {
	...
	sameAs: ["https://www.instagram.com/alphabellewellness"],
	// openingHours intentionally omitted — confirm real hours with Daniel before adding.
};
